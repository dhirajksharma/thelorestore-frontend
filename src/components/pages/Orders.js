    ...
    return(
        <div className='mx-4 sm:mx-9 text-text'>
            ...
            <div className='h-[90vh]'>
                <h1 className="hidden sm:block text-2xl md:text-3xl lg:text-4xl font-serif mt-2 border-b-2 border-accent w-1/3 pb-1 col-start-1 col-end-3">Order Details</h1>
                <h1 className='font-["Montserrat"] font-medium tracking-wide border-b mb-1 mt-3 sm:mt-6 sm:w-[25vw] text-text2 border-accent'>Order Summary</h1>
                <div className='ml-4'>
                ...
                <div className='mt-4'>
                    <h1 className='mt-4 font-["Montserrat"] font-medium tracking-wide border-b mb-1 sm:w-[25vw] text-text2 border-accent'>Order Items</h1>
                ...
                className='border-[3px] border-primary-button bg-primary-button rounded-sm py-1 px-2 mb-6 mt-6 font-["Montserrat"] font-medium'
